...
//api 
const description = document.querySelector(".section__four--project--paragraph");
const description2 = document.querySelector(".section__four--project--paragraph2")
const description3 = document.querySelector(".section__four--project--paragraph3")
const description4 = document.querySelector(".section__four--project--paragraph4")
